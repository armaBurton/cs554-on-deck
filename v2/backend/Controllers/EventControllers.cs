...
public class EventsController : ControllerBase
{
    ...
    public async Task<IActionResult> Update(Guid id, [FromBody] CreateEventRequest req)
    {
        ...
        if (userId == null)
            return Unauthorized();
        var updated = await _eventsService.UpdateAsync(id, req, userId.Value);
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        if (userId == null)
            return Unauthorized();
        await _eventsService.DeleteAsync(id, userId.Value);
        return NoContent();
    }
    ...
    )
    {
        ...
        if (userId == null)
            return Unauthorized();
        var attendee = await _eventsService.UpdateAttendeeAsync(id, attendeeId, req, userId.Value);
        return attendee == null ? NotFound() : Ok(attendee);
    }
    ...
    public async Task<IActionResult> DeleteAttendee(Guid id, Guid attendeeId)
    {
        ...
        if (userId == null)
            return Unauthorized();
        await _eventsService.DeleteAttendeeAsync(id, attendeeId, userId.Value);
        return NoContent();
    }
